...
public class QuakeSortInPlace {
    ...
    public void sortByLargestDepth (ArrayList<QuakeEntry> in, int max) {
    ...
    public void sortByMagnitude(ArrayList<QuakeEntry> in) {
        ...
        int i = 0;
        while(!checkInSortedOrder(in) && i < in.size()){
    ...
    public void testSort() {
         ...
         */
        System.out.println("Sort Magn bubble");
    ...
    public void test(){
        ...
        System.out.println("Sort Depth Q1");    
        ...
        System.out.println("Sort Depth Q2");  
        ...
        source = "data/earthQuakeDataWeekDec6sample1.atom";
        list  = parser.read(source);       
        System.out.println("Sort Depth Q3");  
        sortByMagnitudeWithBubbleSortWithCheck(list);
       /* for (QuakeEntry qe: list) { 
            System.out.println(qe);
        } */
